exports.up = function(knex) {
    return knex.schema.createTable("record_register", (record_registerTable) => {
        ...
        record_registerTable.integer("record_id").references("record_id").inTable("record_issues");
        record_registerTable.integer("register_id").references("register_id").inTable("register");
    })
